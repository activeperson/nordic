                            ...
                            <div class="col-sm-5 col-sm-push-7 col-md-4 col-md-push-8">
                                <div class="single-house-details right-content-padding js-right-content details">
                                    ...
                                    <div class="user-added-content user-added-content-padding-right user-added-content-padding-top">
                                        <p>The choice of materials is just as high-quality, too, ensuring a hard-wearing finish that will stand up to a climate where it’s constantly cold or damp. A traditional recreational home for sports-minded people who know how to spend their time in a quality way. If your home is your castle, it leaves you with more time for yourself.</p>
                                    </div>
                                </div>
                            </div>
    ...
    $('.js-sendto-google form').voogAjaxForm({
        success: function() {
            ...
            if (modelName === true || customProject === true) {
                houseModel = 'Buen Popular (Sweden)';
                if (!houseModel) {
...
*/
    ...
    <script type="text/javascript">
        ...
        // add images
        $.ajax({
            url: '/admin/api/elements/357074/contents?name=house_gallery&content_type=gallery',
