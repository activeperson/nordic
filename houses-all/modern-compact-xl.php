                            ...
                            <div class="col-sm-5 col-sm-push-7 col-md-4 col-md-push-8 js-details-forms">
                                <div class="single-house-details details right-content-padding js-right-content">
                                    ...
                                    <div class="details-intro">
                                        <p>Modern Compact XL in the Modern Compact range is designed for the most demanding home-buyers. It represents an all-in-one solution made up of the core module and additional modules.</p>
                                    </div>
                                    ...
                                    <div class="details-specifics">
                                        ...
                                        <div class="details-info">
                                                    ...
                                                    <span class="details-info-detail">141m²</span>
                                                
                                                
                                                    <label class="details-info-label">Bedrooms:</label>
                                                    <span class="details-info-detail">4</span>
...
<tr>
<td style="height: 11px;">Storeys:</td>
<td>2</td>
</tr>
<tr>
<td>Max. length:</td>
...
<ul><li><a href="http://media.voog.com/0000/0039/4069/files/Modern%20Compact%20XL%20plaan%201.k..pdf" target="_blank"><span style="color: rgb(0, 0, 0);">Modern Compact XL 1.floor</span></a><br></li><li><a href="http://media.voog.com/0000/0039/4069/files/Modern%20Compact%20XL%20plaan%202.k..pdf" target="_blank"><span style="color: rgb(0, 0, 0);">Modern Compact XL 2.floor</span></a><br></li></ul>
            ...
            <div class="pswp__ui pswp__ui--hidden">
                ...
                <button class="pswp__button pswp__button--arrow--right" title="Next (arrow right)">
                                ...
                                <div class="user-added-content user-added-content-padding">
                                    <p>Modern Houses’ recreational housing complex in Norway, which took first prize in the Pre-fab Building of the Year contest in 2015, has been developed by architects from Trilog Studio into a contemporary home concept.</p><p>Inspired by the bracing nature of Scandinavia, and being minimalistic and cleverly functional, Modern Compact offers an environmentally friendly, energy class B home solution that is innovative and truly Modern in its elegance. Every detail has been thought through. It comprises a spacious core module with the option of adding further modules for more expansive living.</p><p>This two-storey home features a spacious living room with an open kitchen and dining area. Three of the bedrooms are on the second floor of the core module, while the fourth bedroom is in the additional module. The second module can also be used as a sauna or office. The house features three WCs/bathrooms and storage spaces.</p>
                                </div>
...
*/
    ...
    <script type="text/javascript">
        ...
        // add images
        $.ajax({
            url: '/admin/api/elements/355278/contents?name=house_gallery&content_type=gallery',
